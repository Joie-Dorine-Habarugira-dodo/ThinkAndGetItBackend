...
public class GetProductBySlugTest {
    String slug= "portable-bluetooth-speaker";
    String invalid_slug= "hi";
    @Test
    public void getProductBySlugSuccess() throws IOException {
        Response response = new ProductFlow().getProductBySlug(slug);
    ...
    @Test
    public void getProductBySlugNotFound() throws IOException {
        Response response = new ProductFlow().getProductBySlug(invalid_slug);
